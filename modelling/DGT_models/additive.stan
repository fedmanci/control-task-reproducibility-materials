...
#
# This is the simplest (basic) model. As such, it does not need quite as much
# accuracy in exploring the posterior as other more complex models.
# We suggest running the model with 800 warmup samples, 2100 iterations, a tree-depth of 9,
# and an adapt-delta of 0.99999.
#
#
...
model{
    ...
    for (n in 1:num_trials){
        ...
        options[2] = rew_par[sub[n], block_type[n]] * rew[n,2] + veh_par[sub[n], block_type[n]] * 100 * p1[n] - dst_par[sub[n], block_type[n]] * d12[n];
        options[3] = rew_par[sub[n], block_type[n]] * rew[n,1] + veh_par[sub[n], block_type[n]] * 100 * p2[n] - dst_par[sub[n], block_type[n]] * d21[n];
        options[4] = rew_par[sub[n], block_type[n]] * rew[n,2] + veh_par[sub[n], block_type[n]] * 100 * p2[n] - dst_par[sub[n], block_type[n]] * d22[n];
